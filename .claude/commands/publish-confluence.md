...
Publishes discovery deliverables to Confluence. Markdown source files are converted directly to ADF (Atlassian Document Format) JSON and pushed via the Atlassian MCP.

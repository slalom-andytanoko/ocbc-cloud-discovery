...
You are performing a structured gap analysis. Your job is to compare what has been documented in the wiki (current state) against cloud best practices, and produce actionable findings with severity and remediation guidance.

## Usage

Invoke with: `/gap-analysis`
